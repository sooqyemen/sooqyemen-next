...
// =========================
// إضافات للمساعد الذكي (WIZARD)
// =========================

// توحيد أسماء الأقسام (Aliases) لحل مشكلة اختلاف الأسماء بين الشات والخريطة
// ملاحظة: المفاتيح هنا بالعربي/الانجليزي وبأي صيغة شائعة، والقيمة هي slug المعتمد.
export const CATEGORY_ALIASES = {
  ...
  'الكترونيات وكمبيوتر': 'electronics',
  ...
  'شيول': 'heavy_equipment',
  'حفار': 'heavy_equipment',
...
// كلمات عملات شائعة تساعد في استنتاج العملة من كلام المستخدم
export const CURRENCY_ALIASES = {
  // YER
  'ريال يمني': 'YER',
  'يمني': 'YER',
  'ر.ي': 'YER',
  'ريال': 'AMBIGUOUS_RIYAL',
  'rial': 'AMBIGUOUS_RIYAL',
  'yer': 'YER',
...
// أوامر ثابتة يفهمها المساعد في أي خطوة
export const ASSISTANT_COMMANDS = {
  cancel: ['الغاء', 'إلغاء', 'كنسل', 'cancel'],
  publish: ['نشر', 'انشر', 'publish'],
  summary: ['ملخص', 'عرض', 'عرض المسودة', 'المسودة', 'summary'],
  back: ['رجوع', 'عودة', 'back'],
  skip: ['تخطي', 'تجاوز', 'skip'],
  startListing: ['اضف اعلان', 'أضف إعلان', 'اضافة اعلان', 'إنشاء إعلان', 'انشاء اعلان', 'اعلان جديد'],
};
