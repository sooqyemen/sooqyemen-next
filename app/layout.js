...
export const metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/icon-512-maskable.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
    ],
  ...
  return (
    <html lang="ar" dir="rtl">
      <head>
        ...
        />
        <meta name="theme-color" content="#0b1a2a" media="(prefers-color-scheme: light)" />
