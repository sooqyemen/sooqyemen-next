...
export default function Header() {
  ...
  // ✅ دالة لمعرفة إذا كان لديك رسائل غير مقروءة
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        /* ========== أنماط قائمة الجوال ========== */
        /* (إبقاء جميع أنماط القائمة الجانبية كما هي من الكود السابق) */
        .sy-backdrop {
          position: fixed;
          top: 0;
          left: 0;
