...
export {
  ...
  ANIMAL_TYPES,
  JOB_TYPES,
  SERVICE_TYPES,  normalizeElectronicsType,
...
export function inferListingTaxonomy(listing, rootKey) {
  ...
  if (root === 'motorcycles') {
    const m = inferMotorcycleFromListing(listing || {});
    out.motorcycleBrand = m.motorcycleBrand || 'other';
    out.motorcycleModel = m.motorcycleModel || '';
  }
